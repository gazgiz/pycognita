...
def test_can_process_uncapped_valid_header():
    ...
    with patch("builtins.open", mock_open(read_data=b"From user@example.com Fri Jul 8 12:00:00 2011")), \
...
def test_can_process_uncapped_invalid_header():
    ...
    with patch("builtins.open", mock_open(read_data=b"Not a mailbox file")), \
         patch("os.path.isfile", return_value=True):
