...
from cognita.caps import Caps, caps_to_turtle, caps_triples, format_caps, summarize_caps
...
def test_caps_creation_and_label():
    caps = Caps(
        ...
        name="jpeg",
        params={"description": "JPEG Image", "extensions": ["jpg", "jpeg"]},
    )
...
def test_format_caps():
    caps = Caps(
        ...
        name="png",
        params={"extensions": ["png"], "description": "PNG Image"},
    )
